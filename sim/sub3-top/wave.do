...
add wave -group gen_testdata   -radix unsigned tb_udp_top/gen_testdata_inst/*
add wave -group fpga_core   -radix unsigned tb_udp_top/TEST_DUT/*
add wave -group udp_top   -radix unsigned tb_udp_top/DUT/*
add wave -group udp_tx_path   -radix unsigned tb_udp_top/DUT/udp_tx_path_inst/*