...
module gen_testdata #(
    ...
    wire [                      1-1:0] sample_flag;
    reg  [$clog2(AD7380_DIV_FREQ)-1:0] cnt = 0;
    reg  [                      1-1:0] start_flag_d1;
    reg  [                      1-1:0] start_flag_d2;
    wire [                      1-1:0] start_flag_pos;
    ...
    assign sample_flag = cnt_1s > 0 && cnt_1s < SYS_FREQ;
